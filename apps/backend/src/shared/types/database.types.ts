...
// Backward-compatible aliases used by backend services
export type InsertTables<TableName extends keyof DefaultSchema["Tables"]> =
  TablesInsert<TableName>
export type UpdateTables<TableName extends keyof DefaultSchema["Tables"]> =
